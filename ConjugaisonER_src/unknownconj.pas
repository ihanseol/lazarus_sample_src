{**********************************************************}
{* Unité "verbe inconnu" pour l'application ConjugaisonER *}
{**********************************************************}
...
{ Form activation: save actual seelctions }
...
begin
  ...
  S += 'par lui-même les exceptions de conjugaisons tels les verbes en -ger, -eler/eter, etc.';
  Memo1.Clear;
  Memo1.Lines.Text := S;
